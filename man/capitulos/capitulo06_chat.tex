...
\begin{lstlisting}[language=bash, caption={Ejemplos de consultas informativas}]
"Cual es el estado del sistema?"
"Cuanto espacio libre tengo en disco?"
"Muestrame los logs de conexiones recientes"
"Que aplicaciones tengo instaladas?"
"Explicame que es una ruta proxy"
\end{lstlisting}
...
\begin{lstlisting}[language=bash, caption={Comandos operativos via chat}]
"Crear nueva conexion al servidor produccion"
"Abrir la aplicacion de correo"
"Desactivar el proxy para la app de testing"
"Generar reporte de auditoria de la ultima semana"
"Limpiar los logs de sesion"
\end{lstlisting}
...
\begin{lstlisting}[language=bash, caption={Secuencia de automatizacion}]
Usuario: "Crea un backup diario de la base de datos"
Sandra: "He configurado una tarea programada para backup diario a las 02:00 AM. 
         Se guardaran en /backups/automaticos/ y se mantendran las ultimas 30 copias."
\end{lstlisting}
